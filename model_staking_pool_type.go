...
// StakingPoolType the model 'StakingPoolType'
type StakingPoolType string

// List of StakingPoolType
const (
	STAKINGPOOLTYPE_BABYLON StakingPoolType = "Babylon"
	STAKINGPOOLTYPE_EIGEN_LAYER_NATIVE_ETH StakingPoolType = "EigenLayerNativeETH"
	STAKINGPOOLTYPE_EIGEN_LAYER_LST StakingPoolType = "EigenLayerLst"
)
