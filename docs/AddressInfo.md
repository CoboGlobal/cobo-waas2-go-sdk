...
**TaprootScriptTreeHash** | Pointer to **string** | The information about a tweaked address. | [optional] 
**TaprootInternalAddress** | Pointer to **string** | The original address that to be tweaked. | [optional] 
