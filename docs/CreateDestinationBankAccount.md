...
`func (o *CreateDestinationBankAccount) GetBankCity() string`

GetBankCity returns the BankCity field if non-nil, zero value otherwise.

### GetBankCityOk

`func (o *CreateDestinationBankAccount) GetBankCityOk() (*string, bool)`
...
`func (o *CreateDestinationBankAccount) SetBankCity(v string)`

SetBankCity sets BankCity field to given value.

### HasBankCity

`func (o *CreateDestinationBankAccount) HasBankCity() bool`

HasBankCity returns a boolean if a field has been set.

### GetRoutingValue

`func (o *CreateDestinationBankAccount) GetRoutingValue() string`

GetRoutingValue returns the RoutingValue field if non-nil, zero value otherwise.

### GetRoutingValueOk

`func (o *CreateDestinationBankAccount) GetRoutingValueOk() (*string, bool)`
...
`func (o *CreateDestinationBankAccount) SetRoutingValue(v string)`

SetRoutingValue sets RoutingValue field to given value.

### HasRoutingValue

`func (o *CreateDestinationBankAccount) HasRoutingValue() bool`
