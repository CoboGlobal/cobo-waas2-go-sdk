...
`func NewCreateBatchAllocationRequest(requestId string, sourceType PaymentSourceType, allocationRequests []AllocationRequest, ) *CreateBatchAllocationRequest`
...
`func (o *CreateBatchAllocationRequest) GetSourceType() PaymentSourceType`

GetSourceType returns the SourceType field if non-nil, zero value otherwise.

### GetSourceTypeOk

`func (o *CreateBatchAllocationRequest) GetSourceTypeOk() (*PaymentSourceType, bool)`
...
`func (o *CreateBatchAllocationRequest) SetSourceType(v PaymentSourceType)`
