...
**UtxoChange** | Pointer to [**TransactionUtxoChange**](TransactionUtxoChange.md) | Deprecated. Use &#x60;utxo_changes&#x60; instead. | [optional] 
**UtxoChanges** | Pointer to [**[]TransactionUtxoChange**](TransactionUtxoChange.md) | The UTXO change outputs in the transaction. | [optional] 
...
GetUtxoChanges returns the UtxoChanges field if non-nil, zero value otherwise.

### GetUtxoChangesOk

`func (o *TransactionRawTxInfo) GetUtxoChangesOk() (*[]TransactionUtxoChange, bool)`

GetUtxoChangesOk returns a tuple with the UtxoChanges field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetUtxoChanges sets UtxoChanges field to given value.
