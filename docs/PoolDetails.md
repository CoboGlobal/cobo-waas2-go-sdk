...
**MinStakePeriod** | Pointer to **float32** | The minimum staking period in days. | [optional] 
**MaxStakePeriod** | Pointer to **float32** | The maximum staking period in days. | [optional] 
