...
------------ | ------------- | ------------- | -------------
**StartTime** | **int32** | The start time of the report. Unix timestamp. | 
**EndTime** | **int32** | The end time of the report. Unix timestamp. | 
**ReportExportFormat** | [**ReportExportFormat**](ReportExportFormat.md) |  | 
**ReportTypes** | [**[]ReportType**](ReportType.md) |  | 
**TokenIds** | Pointer to **[]string** | The token IDs of the report. | [optional] 
