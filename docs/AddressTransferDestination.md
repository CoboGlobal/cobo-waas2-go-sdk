...
**ChangeOutputType** | Pointer to **string** | The type of change output: **Last** means the change output is located at the end of the transaction&#39;s outputs, **Last** is the default value. while **First** means it is located at the beginning of the transaction&#39;s outputs.  | [optional] 
