...
**OrderIds** | Pointer to **[]string** | A list of unique order IDs to be included in this settlement.  - This field is only applicable when &#x60;settlement_type&#x60; is set to &#x60;Merchant&#x60;. - If provided, the settlement will only apply to the specified orders.  | [optional] 
...
`func (o *SettlementDetail) GetCryptoAddress() string`

GetCryptoAddress returns the CryptoAddress field if non-nil, zero value otherwise.

### GetCryptoAddressOk

`func (o *SettlementDetail) GetCryptoAddressOk() (*string, bool)`
...
`func (o *SettlementDetail) SetCryptoAddress(v string)`

SetCryptoAddress sets CryptoAddress field to given value.

### HasCryptoAddress

`func (o *SettlementDetail) HasCryptoAddress() bool`
