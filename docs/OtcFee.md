...
------------ | ------------- | ------------- | -------------
**FeeRate** | **string** | The OTC fee rate applied to calculate the variable portion of the OTC fee.  This rate-based fee is charged cumulatively on top of &#x60;otc_fixed_fee&#x60;.  | 
