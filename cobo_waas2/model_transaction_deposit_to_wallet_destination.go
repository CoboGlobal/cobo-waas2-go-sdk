...
// TransactionDepositToWalletDestination Information about the transaction destination type `DepositToWallet`. Switch between the tabs to display the properties for different transaction destinations. 
