...
func (o *PaymentPayoutDetail) GetSourceType() PaymentSourceType {
...
// and a boolean to check if the value has been set.
func (o *PaymentPayoutDetail) GetSourceTypeOk() (*PaymentSourceType, bool) {
	if o == nil || IsNil(o.SourceType) {
		return nil, false
	}
...
func (o *PaymentPayoutDetail) HasSourceType() bool {
	if o != nil && !IsNil(o.SourceType) {
		return true
	}
...
func (o *PaymentPayoutDetail) SetSourceType(v PaymentSourceType) {
	o.SourceType = &v
}
