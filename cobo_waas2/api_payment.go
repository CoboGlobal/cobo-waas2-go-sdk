...
type ApiCreateBankWithdrawalRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	createBankWithdrawalRequest *CreateBankWithdrawalRequest
}

// The request body to create a bank withdrawal.
func (r ApiCreateBankWithdrawalRequest) CreateBankWithdrawalRequest(createBankWithdrawalRequest CreateBankWithdrawalRequest) ApiCreateBankWithdrawalRequest {
	r.createBankWithdrawalRequest = &createBankWithdrawalRequest
	return r
}

func (r ApiCreateBankWithdrawalRequest) Execute() (*PaymentBankWithdrawal, *http.Response, error) {
	return r.ApiService.CreateBankWithdrawalExecute(r)
}

/*
CreateBankWithdrawal Create bank withdrawal

This operation creates a bank withdrawal from a virtual account to a target bank account.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateBankWithdrawalRequest
*/
func (a *PaymentAPIService) CreateBankWithdrawal(ctx context.Context) ApiCreateBankWithdrawalRequest {
	return ApiCreateBankWithdrawalRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PaymentAPIService) CreateBankWithdrawalExecute(r ApiCreateBankWithdrawalRequest) (*PaymentBankWithdrawal, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaymentBankWithdrawal
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.CreateBankWithdrawal")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payments/bank_withdrawals"
	...
	// body params
	localVarPostBody = r.createBankWithdrawalRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGetBankWithdrawalByIdRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	bankWithdrawalId string
}

func (r ApiGetBankWithdrawalByIdRequest) Execute() (*PaymentBankWithdrawalDetail, *http.Response, error) {
	return r.ApiService.GetBankWithdrawalByIdExecute(r)
}

/*
GetBankWithdrawalById Get bank withdrawal information

This operation retrieves the information of a specific bank withdrawal.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param bankWithdrawalId The bank withdrawal ID.
 @return ApiGetBankWithdrawalByIdRequest
*/
func (a *PaymentAPIService) GetBankWithdrawalById(ctx context.Context, bankWithdrawalId string) ApiGetBankWithdrawalByIdRequest {
	return ApiGetBankWithdrawalByIdRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PaymentAPIService) GetBankWithdrawalByIdExecute(r ApiGetBankWithdrawalByIdRequest) (*PaymentBankWithdrawalDetail, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaymentBankWithdrawalDetail
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.GetBankWithdrawalById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payments/bank_withdrawals/{bank_withdrawal_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"bank_withdrawal_id"+"}", url.PathEscape(parameterValueToString(r.bankWithdrawalId, "bankWithdrawalId")), -1)
...
type ApiGetMerchantKycRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	merchantId string
}

func (r ApiGetMerchantKycRequest) Execute() (*MerchantKycSubmission, *http.Response, error) {
	return r.ApiService.GetMerchantKycExecute(r)
}

/*
GetMerchantKyc Get merchant KYC

This operation retrieves the KYC submission for a specified merchant.
...
The merchant ID can be retrieved by calling [List all merchants](https://www.cobo.com/developers/v2/api-references/payment/list-all-merchants).
 ...
 @return ApiGetMerchantKycRequest
*/
func (a *PaymentAPIService) GetMerchantKyc(ctx context.Context, merchantId string) ApiGetMerchantKycRequest {
	return ApiGetMerchantKycRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PaymentAPIService) GetMerchantKycExecute(r ApiGetMerchantKycRequest) (*MerchantKycSubmission, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantKycSubmission
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.GetMerchantKyc")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payments/merchants/{merchant_id}/kyc"
...
type ApiGetPaymentBankAccountBalanceRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	bankAccountId string
}

func (r ApiGetPaymentBankAccountBalanceRequest) Execute() (*PaymentBankAccountBalance, *http.Response, error) {
	return r.ApiService.GetPaymentBankAccountBalanceExecute(r)
}

/*
GetPaymentBankAccountBalance Get bank account balance

This operation retrieves the balance of a destination bank account, only available for bank accounts with tag `VA`.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param bankAccountId The destination bank account ID.
 @return ApiGetPaymentBankAccountBalanceRequest
*/
func (a *PaymentAPIService) GetPaymentBankAccountBalance(ctx context.Context, bankAccountId string) ApiGetPaymentBankAccountBalanceRequest {
	return ApiGetPaymentBankAccountBalanceRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PaymentAPIService) GetPaymentBankAccountBalanceExecute(r ApiGetPaymentBankAccountBalanceRequest) (*PaymentBankAccountBalance, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaymentBankAccountBalance
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.GetPaymentBankAccountBalance")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payments/balance/bank_accounts/{bank_account_id}"
...
type ApiListBalanceChangesRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	sourceAccount *string
	limit *int32
...
// The maximum number of objects to return. For most operations, the value range is [1, 50].
func (r ApiListBalanceChangesRequest) Limit(limit int32) ApiListBalanceChangesRequest {
	r.limit = &limit
	return r
}

// A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. 
func (r ApiListBalanceChangesRequest) Before(before string) ApiListBalanceChangesRequest {
	r.before = &before
	return r
}

// A cursor indicating the position after the current page. This value is generated by Cobo and returned in the response. You do not need to provide it on the first request. When paginating forward (to the next page), you should pass the after value returned from the last response. 
func (r ApiListBalanceChangesRequest) After(after string) ApiListBalanceChangesRequest {
	r.after = &after
	return r
}

// The token ID used to filter balance changes. For a complete list of supported tokens, see [Cobo Payments Guide](https://www.cobo.com/payments/en/guides/overview). 
func (r ApiListBalanceChangesRequest) TokenId(tokenId string) ApiListBalanceChangesRequest {
	r.tokenId = &tokenId
	return r
}
...
func (r ApiListBalanceChangesRequest) FlowDirection(flowDirection PaymentBalanceFlowDirection) ApiListBalanceChangesRequest {
...
func (r ApiListBalanceChangesRequest) MinCreatedTimestamp(minCreatedTimestamp int64) ApiListBalanceChangesRequest {
...
func (r ApiListBalanceChangesRequest) MaxCreatedTimestamp(maxCreatedTimestamp int64) ApiListBalanceChangesRequest {
	r.maxCreatedTimestamp = &maxCreatedTimestamp
	return r
}

// The source type used to filter balance changes. Possible values include: - &#x60;Init&#x60;: Balance change caused by initialization. - &#x60;OrderIn&#x60;: Balance change from an order-in payment. - &#x60;LatePayment&#x60;: Balance change from a late payment. - &#x60;TopUp&#x60;: Balance change from a top-up. - &#x60;UnexceptedIn&#x60;: Balance change from an unexpected incoming payment. - &#x60;RefundOut&#x60;: Balance change from a refund payout. - &#x60;Payout&#x60;: Balance change from a payout. - &#x60;UnexceptedOut&#x60;: Balance change from an unexpected outgoing payment. - &#x60;Allocation&#x60;: Balance change from an allocation. - &#x60;SettlementNetwork&#x60;: Balance change from the settlement network. - &#x60;BulkSend&#x60;: Balance change from a bulk send.  &lt;Note&gt;When specifying &#x60;source_id&#x60;, you must also specify &#x60;source_type&#x60;.&lt;/Note&gt; 
func (r ApiListBalanceChangesRequest) SourceType(sourceType PaymentBalanceChangeSourceType) ApiListBalanceChangesRequest {
	r.sourceType = &sourceType
	return r
}

// The source ID used to filter balance changes.  &lt;Note&gt;When specifying &#x60;source_id&#x60;, you must also specify &#x60;source_type&#x60;.&lt;/Note&gt; 
func (r ApiListBalanceChangesRequest) SourceId(sourceId string) ApiListBalanceChangesRequest {
	r.sourceId = &sourceId
	return r
}

func (r ApiListBalanceChangesRequest) Execute() (*PaymentBalanceChangeResponse, *http.Response, error) {
	return r.ApiService.ListBalanceChangesExecute(r)
}

/*
ListBalanceChanges List balance changes
...
For more information, see [Cobo Payments Guide](https://www.cobo.com/payments/en/guides/overview).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListBalanceChangesRequest
*/
func (a *PaymentAPIService) ListBalanceChanges(ctx context.Context) ApiListBalanceChangesRequest {
	return ApiListBalanceChangesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PaymentAPIService) ListBalanceChangesExecute(r ApiListBalanceChangesRequest) (*PaymentBalanceChangeResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaymentBalanceChangeResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.ListBalanceChanges")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payments/balance_changes"
	...
	if r.flowDirection != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "flow_direction", r.flowDirection, "")
	}
...
type ApiListBankWithdrawalsRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	limit *int32
	before *string
...
// The maximum number of objects to return. For most operations, the value range is [1, 50].
func (r ApiListBankWithdrawalsRequest) Limit(limit int32) ApiListBankWithdrawalsRequest {
	r.limit = &limit
	return r
}

// A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. 
func (r ApiListBankWithdrawalsRequest) Before(before string) ApiListBankWithdrawalsRequest {
	r.before = &before
	return r
}

// A cursor indicating the position after the current page. This value is generated by Cobo and returned in the response. You do not need to provide it on the first request. When paginating forward (to the next page), you should pass the after value returned from the last response. 
func (r ApiListBankWithdrawalsRequest) After(after string) ApiListBankWithdrawalsRequest {
	r.after = &after
	return r
}

// The request ID.
func (r ApiListBankWithdrawalsRequest) RequestId(requestId string) ApiListBankWithdrawalsRequest {
	r.requestId = &requestId
	return r
}

// Filter by bank withdrawal status.
func (r ApiListBankWithdrawalsRequest) Status(status PaymentBankWithdrawalStatus) ApiListBankWithdrawalsRequest {
	r.status = &status
	return r
}

func (r ApiListBankWithdrawalsRequest) Execute() (*ListBankWithdrawals200Response, *http.Response, error) {
	return r.ApiService.ListBankWithdrawalsExecute(r)
}

/*
ListBankWithdrawals List bank withdrawals

This operation retrieves the list of bank withdrawals.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListBankWithdrawalsRequest
*/
func (a *PaymentAPIService) ListBankWithdrawals(ctx context.Context) ApiListBankWithdrawalsRequest {
	return ApiListBankWithdrawalsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PaymentAPIService) ListBankWithdrawalsExecute(r ApiListBankWithdrawalsRequest) (*ListBankWithdrawals200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListBankWithdrawals200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.ListBankWithdrawals")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiListDestinationEntriesRequest struct {
	...
	bankAccountTag *DestinationBankAccountTag
}
...
func (r ApiListDestinationEntriesRequest) BankAccountTag(bankAccountTag DestinationBankAccountTag) ApiListDestinationEntriesRequest {
	r.bankAccountTag = &bankAccountTag
	return r
}
...
func (a *PaymentAPIService) ListDestinationEntriesExecute(r ApiListDestinationEntriesRequest) (*ListDestinationEntries200Response, *http.Response, error) {
	...
	if r.bankAccountTag != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "bank_account_tag", r.bankAccountTag, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiSubmitMerchantKycRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	merchantId string
...
func (r ApiSubmitMerchantKycRequest) Execute() (*MerchantKycInfo, *http.Response, error) {
	return r.ApiService.SubmitMerchantKycExecute(r)
}

/*
SubmitMerchantKyc Submit merchant KYC
...
<Note>If the merchant KYC status is `Disabled`, this operation cannot be used to resubmit KYC information.</Note>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param merchantId The merchant ID.
 @return ApiSubmitMerchantKycRequest
*/
func (a *PaymentAPIService) SubmitMerchantKyc(ctx context.Context, merchantId string) ApiSubmitMerchantKycRequest {
	return ApiSubmitMerchantKycRequest{
		ApiService: a,
		ctx: ctx,
		merchantId: merchantId,
...
func (a *PaymentAPIService) SubmitMerchantKycExecute(r ApiSubmitMerchantKycRequest) (*MerchantKycInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantKycInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.SubmitMerchantKyc")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.submitMerchantKyc
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiUploadPaymentFileRequest struct {
	ctx context.Context
	ApiService *PaymentAPIService
	file *os.File
}
...
// The file to upload.
func (r ApiUploadPaymentFileRequest) File(file *os.File) ApiUploadPaymentFileRequest {
	r.file = file
	return r
}

func (r ApiUploadPaymentFileRequest) Execute() (*PaymentUploadedFile, *http.Response, error) {
	return r.ApiService.UploadPaymentFileExecute(r)
}
...
func (a *PaymentAPIService) UploadPaymentFileExecute(r ApiUploadPaymentFileRequest) (*PaymentUploadedFile, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentAPIService.UploadPaymentFile")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payments/files"
