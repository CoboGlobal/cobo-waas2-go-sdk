...
// checks if the PaymentSubscriptionUpdateEventData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentSubscriptionUpdateEventData{}

// PaymentSubscriptionUpdateEventData struct for PaymentSubscriptionUpdateEventData
type PaymentSubscriptionUpdateEventData struct {
...
type _PaymentSubscriptionUpdateEventData PaymentSubscriptionUpdateEventData
...
func NewPaymentSubscriptionUpdateEventData(dataType string, planId string, subscriptionId string, merchantId string, merchantAddress string, userAddress string, tokenId string, startTime int32, expirationTime int32, chargesMade int32, periodType PaymentSubscriptionPeriodType, periods int32, interval int32, status PaymentSubscriptionStatus, createdTimestamp int32, updatedTimestamp int32) *PaymentSubscriptionUpdateEventData {
	this := PaymentSubscriptionUpdateEventData{}
...
func (o PaymentSubscriptionUpdateEventData) MarshalJSON() ([]byte, error) {
...
func (o PaymentSubscriptionUpdateEventData) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentSubscriptionUpdateEventData) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentSubscriptionUpdateEventData := _PaymentSubscriptionUpdateEventData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	//decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymentSubscriptionUpdateEventData)

	if err != nil {
		return err
	}

	*o = PaymentSubscriptionUpdateEventData(varPaymentSubscriptionUpdateEventData)

	return err
}

type NullablePaymentSubscriptionUpdateEventData struct {
	value *PaymentSubscriptionUpdateEventData
	isSet bool
}

func (v NullablePaymentSubscriptionUpdateEventData) Get() *PaymentSubscriptionUpdateEventData {
	return v.value
}

func (v *NullablePaymentSubscriptionUpdateEventData) Set(val *PaymentSubscriptionUpdateEventData) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentSubscriptionUpdateEventData) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentSubscriptionUpdateEventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentSubscriptionUpdateEventData(val *PaymentSubscriptionUpdateEventData) *NullablePaymentSubscriptionUpdateEventData {
	return &NullablePaymentSubscriptionUpdateEventData{value: val, isSet: true}
}

func (v NullablePaymentSubscriptionUpdateEventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentSubscriptionUpdateEventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
