...
func Test_cobo_waas2_WalletsAPIService(t *testing.T) {
	...
	t.Run("Test WalletsAPIService GetMaxTransferableValueWithFeeModel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var walletId string

		resp, httpRes, err := apiClient.WalletsAPI.GetMaxTransferableValueWithFeeModel(ctx, walletId).Execute()
	...
	t.Run("Test WalletsAPIService ListAccountBalances", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.WalletsAPI.ListAccountBalances(ctx, walletId, chainId).Execute()
	...
	t.Run("Test WalletsAPIService ListTransactionUtxos", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var walletId string

		resp, httpRes, err := apiClient.WalletsAPI.ListTransactionUtxos(ctx, walletId).Execute()
	...
	t.Run("Test WalletsAPIService RefreshAddressBalancesByToken", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.WalletsAPI.RefreshAddressBalancesByToken(ctx, walletId, tokenId).Execute()
