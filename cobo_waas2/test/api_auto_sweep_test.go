...
func Test_cobo_waas2_AutoSweepAPIService(t *testing.T) {
	...
	t.Run("Test AutoSweepAPIService CancelAutoSweepTaskById", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var taskId string

		resp, httpRes, err := apiClient.AutoSweepAPI.CancelAutoSweepTaskById(ctx, taskId).Execute()
	...
	t.Run("Test AutoSweepAPIService ListWalletSweepToAddresses", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AutoSweepAPI.ListWalletSweepToAddresses(ctx).Execute()
