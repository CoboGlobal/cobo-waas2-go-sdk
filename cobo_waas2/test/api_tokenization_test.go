...
func Test_cobo_waas2_TokenizationAPIService(t *testing.T) {
	...
	t.Run("Test TokenizationAPIService UpdateAllowlistAddresses", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var tokenId string

		resp, httpRes, err := apiClient.TokenizationAPI.UpdateAllowlistAddresses(ctx, tokenId).Execute()
