...
func Test_cobo_waas2_ComplianceAPIService(t *testing.T) {
	...
	t.Run("Test ComplianceAPIService RefundFunds", func(t *testing.T) {
	...
	t.Run("Test ComplianceAPIService UnfreezeFunds", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.ComplianceAPI.UnfreezeFunds(ctx).Execute()
