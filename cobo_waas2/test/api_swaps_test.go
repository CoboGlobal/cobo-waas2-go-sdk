...
func Test_cobo_waas2_SwapsAPIService(t *testing.T) {
	...
	t.Run("Test SwapsAPIService GetSwapQuote", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SwapsAPI.GetSwapQuote(ctx).Execute()
	...
	t.Run("Test SwapsAPIService ListSwapEnabledTokens", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SwapsAPI.ListSwapEnabledTokens(ctx).Execute()
