...
type CreateAddressRequest struct {
	...
	// The number of addresses to generate. If you want to generate a tweaked address, `count` can only be `1`.
	Count int32 `json:"count"`
	// The information about the new address. This parameter is required only if you want to tweak a Taproot address.
	TaprootScriptTreeHash *string `json:"taproot_script_tree_hash,omitempty"`
	// The Taproot address you want to tweak. This parameter is required only if you want to tweak a Taproot address.
