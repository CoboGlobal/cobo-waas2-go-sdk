...
type ApiCheckFeeStationUsageRequest struct {
	ctx context.Context
...
func (r ApiCheckFeeStationUsageRequest) Execute() (*FeeStationCheckFeeStationUsageResponse, *http.Response, error) {
	return r.ApiService.CheckFeeStationUsageExecute(r)
}

/*
CheckFeeStationUsage Check Fee Station usage
...
It determines whether Fee station can be used, checks if the Fee Station balance is sufficient, and returns a breakdown of the amounts involved, including any portion that must be covered by the user or sponsored in USD stablecoin.
 ...
 @return ApiCheckFeeStationUsageRequest
*/
func (a *FeeStationAPIService) CheckFeeStationUsage(ctx context.Context) ApiCheckFeeStationUsageRequest {
	return ApiCheckFeeStationUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FeeStationAPIService) CheckFeeStationUsageExecute(r ApiCheckFeeStationUsageRequest) (*FeeStationCheckFeeStationUsageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FeeStationCheckFeeStationUsageResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeeStationAPIService.CheckFeeStationUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fee_station/check_fee_station_usage"
	...
	// body params
	localVarPostBody = r.feeStationCheckFeeStationUsage
...
type ApiListFeeStationFiatTransactionsRequest struct {
	ctx context.Context
	ApiService *FeeStationAPIService
...
func (r ApiListFeeStationFiatTransactionsRequest) TransactionIds(transactionIds string) ApiListFeeStationFiatTransactionsRequest {
...
func (r ApiListFeeStationFiatTransactionsRequest) TransactionType(transactionType FeeStationFiatTransactionType) ApiListFeeStationFiatTransactionsRequest {
...
func (r ApiListFeeStationFiatTransactionsRequest) MinCreatedTimestamp(minCreatedTimestamp int64) ApiListFeeStationFiatTransactionsRequest {
...
func (r ApiListFeeStationFiatTransactionsRequest) MaxCreatedTimestamp(maxCreatedTimestamp int64) ApiListFeeStationFiatTransactionsRequest {
	r.maxCreatedTimestamp = &maxCreatedTimestamp
	return r
}

// A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. 
func (r ApiListFeeStationFiatTransactionsRequest) Before(before string) ApiListFeeStationFiatTransactionsRequest {
	r.before = &before
	return r
}

// A cursor indicating the position after the current page. This value is generated by Cobo and returned in the response. You do not need to provide it on the first request. When paginating forward (to the next page), you should pass the after value returned from the last response. 
func (r ApiListFeeStationFiatTransactionsRequest) After(after string) ApiListFeeStationFiatTransactionsRequest {
	r.after = &after
	return r
}

// The maximum number of objects to return. For most operations, the value range is [1, 50].
func (r ApiListFeeStationFiatTransactionsRequest) Limit(limit int32) ApiListFeeStationFiatTransactionsRequest {
	r.limit = &limit
	return r
}

func (r ApiListFeeStationFiatTransactionsRequest) Execute() (*ListFeeStationFiatTransactions200Response, *http.Response, error) {
	return r.ApiService.ListFeeStationFiatTransactionsExecute(r)
}

/*
ListFeeStationFiatTransactions List Fee Station fiat transactions

This operation retrieves all Fee Station fiat transactions under your organization.

You can filter the results by request IDs, transaction IDs, transaction type, and created timestamp. You can also paginate your query results.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListFeeStationFiatTransactionsRequest
*/
func (a *FeeStationAPIService) ListFeeStationFiatTransactions(ctx context.Context) ApiListFeeStationFiatTransactionsRequest {
	return ApiListFeeStationFiatTransactionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FeeStationAPIService) ListFeeStationFiatTransactionsExecute(r ApiListFeeStationFiatTransactionsRequest) (*ListFeeStationFiatTransactions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListFeeStationFiatTransactions200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeeStationAPIService.ListFeeStationFiatTransactions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fee_station/fiat_transactions"
