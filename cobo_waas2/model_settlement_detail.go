...
// GetSettlementRequestId returns the SettlementRequestId field value if set, zero value otherwise.
func (o *SettlementDetail) GetSettlementRequestId() string {
	if o == nil || IsNil(o.SettlementRequestId) {
		var ret string
		return ret
	}
...
// GetSettlementRequestIdOk returns a tuple with the SettlementRequestId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSettlementRequestId gets a reference to the given string and assigns it to the SettlementRequestId field.
...
func (o SettlementDetail) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SettlementRequestId) {
