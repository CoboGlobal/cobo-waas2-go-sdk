...
// MessageSignSourceType The wallet subtype of the transaction source. Refer to [Transaction sources and destinations](/v2/guides/sources-and-destinations) for details. 
