...
// CustodialTransferSource The information about the transaction source types `Asset` and `Web3`. Switch between the tabs to display the properties for different transaction sources.
