...
type ApiCancelAutoSweepTaskByIdRequest struct {
	ctx context.Context
	ApiService *AutoSweepAPIService
	taskId string
}

func (r ApiCancelAutoSweepTaskByIdRequest) Execute() (*AutoSweepTask, *http.Response, error) {
	return r.ApiService.CancelAutoSweepTaskByIdExecute(r)
}

/*
CancelAutoSweepTaskById Cancel auto sweep task

This operation cancels an in-progress auto sweep task by its ID.

Only tasks with the `Submitted` status can be cancelled. Tasks that have already
been processed (status `TransactionCreated`) cannot be cancelled.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param taskId The auto sweep task ID.
 @return ApiCancelAutoSweepTaskByIdRequest
*/
func (a *AutoSweepAPIService) CancelAutoSweepTaskById(ctx context.Context, taskId string) ApiCancelAutoSweepTaskByIdRequest {
	return ApiCancelAutoSweepTaskByIdRequest{
		ApiService: a,
		ctx: ctx,
		taskId: taskId,
...
func (a *AutoSweepAPIService) CancelAutoSweepTaskByIdExecute(r ApiCancelAutoSweepTaskByIdRequest) (*AutoSweepTask, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AutoSweepAPIService.CancelAutoSweepTaskById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auto_sweep/tasks/{task_id}/cancel"
