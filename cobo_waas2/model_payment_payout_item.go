...
func NewPaymentPayoutItem(payoutItemId string, payoutId string, amount string, status PaymentPayoutItemStatus) *PaymentPayoutItem {
...
func (o *PaymentPayoutItem) GetMerchantId() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentPayoutItem) GetMerchantIdOk() (*string, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *PaymentPayoutItem) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *PaymentPayoutItem) SetMerchantId(v string) {
	o.MerchantId = &v
}
