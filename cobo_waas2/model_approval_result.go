...
// ApprovalResult Approval result for this user in the transaction approval. Possible values include:    - `Approved`: The transaction is approved.   - `Rejected`: The transaction is rejected. 
